...
del Bot_packet
print('1')
d2 = data2feature(DDoS_packet, 1)
del DDoS_packet
print('2')
d3 = data2feature(DoSGoldenEye_packet, 1)
del DoSGoldenEye_packet
print('3')
d4 = data2feature(DoSHulk_packet, 1)
del DoSHulk_packet
print('4')
d5 = data2feature(DoSSlowhttptest_packet, 1)
del DoSSlowhttptest_packet
print('5')
d6 = data2feature(DoSslowloris_packet, 1)
del DoSslowloris_packet
print('6')
d7 = data2feature(FTPPatator_packet, 1)
del FTPPatator_packet
print('7')
d8 = data2feature(PortScan_packet, 1)
del PortScan_packet
print('8')
d9 = data2feature(SSHPatator_packet, 1)
del SSHPatator_packet
print('9')
d10 = data2feature(WebAttackBruteForce_packet, 1)
del WebAttackBruteForce_packet
print('10')
d11 = data2feature(WebAttackXSS_packet, 1)
...
Data = np.concatenate((d0, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11), axis=0)
...
file=open('accuracy-1DCNN2-1.txt','w')
...
matrix = Visual()
matrix.cm_plot(mlabel,preLabel,['Benign','Attack'],'1DCNN_2_1')
