...
from modifiedCell import BasicLSTMCell
...
rnn_layers = [BasicLSTMCell(size) for size in [256]]
...
file=open('accuracy-OLSTM7-1.txt','w')
...
matrix = Visual()
matrix.cm_plot(mlabel,preLabel,['Benign','Bot','DDoS','DoS','Patator','PortScan','WebAttack'],'OLSTM_7_1')
