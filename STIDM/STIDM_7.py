...
# d3 = data2feature(DoSGoldenEye, 0)
# d4 = data2feature(DoSHulk, 1)
# d5 = data2feature(DoSSlowhttptest, 2)
...
file=open('accuracy-1DCNNLSTM7-1.txt','w')
...
matrix = Visual()
matrix.cm_plot(mlabel,preLabel,['Benign','Bot','DDoS','DoS','Patator','PortScan','WebAttack'],'1DCNN_LSTM_7_1')
